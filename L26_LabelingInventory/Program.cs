namespace L26_LabelingInventory
{
    ...
    class Bow : InventoryItem
    {
        ...
        public Bow() { }
        public override string ToString() { return "bow"; }
    }
    class Rope : InventoryItem
    {
        public Rope(double weigth, double volume) : base(weigth, volume) { }
        public Rope() { }
        public override string ToString() { return "rope"; }
    }
    ...
    class Food : InventoryItem
    {
        ...
        public Food() { }
        public override string ToString() { return "food"; }
    }
    class Sword : InventoryItem
    {
        public Sword(double weigth, double volume) : base(weigth, volume) { }
        public Sword() { }
        public override string ToString() { return "sword"; }
    }
    class Pack
    {
        ...
        {
            string returnString = "Pack containing ";
